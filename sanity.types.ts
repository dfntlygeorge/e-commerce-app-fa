...
// Query: *[_type == "order" && clerkUserId == $userId] | order(orderDate desc) {        ...,products[]{ // span the array if we have embedded products inside            ...,product-> // references        }    }
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    '\n    *[_type == "product" && name match $searchParam] | order(name asc)': SEARCH_PRODUCTS_QUERYResult;
